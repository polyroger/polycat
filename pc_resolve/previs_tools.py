...
# f = allFilesInFolders(r"\\YARN\projects\mov\gra\0_aaa\0_internal\0_project_data\previs_sequences\scn0010")

filelist = allFilesInFolders(r"\\YARN\projects\mov\gra\0_aaa\0_internal\0_project_data\previs_sequences\scn0010_previs")

args = ffmpegArgList(filelist,24,1001)
