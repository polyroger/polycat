...
def createMayaMenus():
    ...
    pm.menuItem(label="Update Refereces",command="update_references.run_reference_update_menu()") # importing the update reference module in the userSetup.py for scriptjob
